...
public class Bird extends Thread {
	...
	private int ooldy;
	// 鸟的图片
	private Image[] bird = { new ImageIcon("gameResource/flappyBirdRes/Birds_01.png").getImage(),
			new ImageIcon("gameResource/flappyBirdRes/Birds_02.png").getImage(),
			new ImageIcon("gameResource/flappyBirdRes/Birds_03.png").getImage() };
	...
	public void move() {
		if (FlappyBirdGameUI.flag == 0) {
			setImageIndex();
			return;
		} else if (FlappyBirdGameUI.flag == 2) {
			return;
		}
		if (flag == Bird.DOWN) {
			long end = System.currentTimeMillis();
			long t = (end - FlappyBirdGameUI.start);
