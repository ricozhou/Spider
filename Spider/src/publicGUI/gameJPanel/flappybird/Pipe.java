...
public class Pipe extends Thread {
	...
	public Pipe(int x, int y, int v) {
		...
		oldx = x;
		oldy = y;
		top = new ImageIcon("gameResource/flappyBirdRes/Pipe_Top.png").getImage();
		bottom = new ImageIcon("gameResource/flappyBirdRes/Pipe_Bottom.png").getImage();
	}

	// 绘制管道
	public void drawSelf(Graphics g) {
		g.drawImage(top, x, y - top.getHeight(null), top.getWidth(null), top.getHeight(null), null);
		g.drawImage(bottom, x, y + FlappyBirdGameUI.w, bottom.getWidth(null), bottom.getHeight(null), null);
	}
	...
	public void resetPipe() {
		if (x <= -52) {
			x = 4 * FlappyBirdGameUI.d - 52;
			y = new Random().nextInt(322 - FlappyBirdGameUI.w) + FlappyBirdGameUI.w + 10;
			isReset = 0;
		}
	}
	...
	public boolean isBirdDied(Bird bird) {
		...
		int[] ypoints2 = { y + FlappyBirdGameUI.w, y + FlappyBirdGameUI.w + bottom.getHeight(null), y + FlappyBirdGameUI.w + bottom.getHeight(null),
				y + FlappyBirdGameUI.w };
