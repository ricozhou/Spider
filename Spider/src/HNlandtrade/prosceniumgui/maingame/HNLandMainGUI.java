package HNlandtrade.prosceniumgui.maingame;
...
public class HNLandMainGUI extends JFrame implements ActionListener {
	// 菜单栏
	JMenuBar menub;
	JMenu files;
	JMenu formats;
	...
	public String[] tabNames = { "解析河南交易系统", "小工具", "小游戏", "小通讯", "小设置" };
	...
	public HNLandMainGUI(PassParameter passParameter) throws IOException {
		initMenu();
	...
	private void initJFrame() throws IOException {
		...
		this.setTitle("解析河南土地交易系统 - (" + passParameter.getUserInfo().getUserName() + ")");
